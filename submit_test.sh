...
srun --get-user-env -t 00:30 -o '%x-%j.out' -e '%x-%j.err' -J Test -D $SLURM_WORKING_DIR -- singularity run --nv $LUSTRE_HOME/containers/$CONT -c "conda activate $CENV && python test.py"
