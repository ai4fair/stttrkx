...
# Data Directories
inputdir="../run_all/"$ann"_processed_ln/pred"  # input from GNN stage as in test/pred
outputdir="../run_all/"$ann"_segmenting_ln/seg" # output of trkx_from_gnn.sh i.e. TrackCands
mkdir -p $outputdir
